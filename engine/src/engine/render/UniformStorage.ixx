...
namespace se::render
{
    export struct UniformValueBase : reflect::ObjectBase
    {
    ...
    export class UniformStorage : public reflect::ObjectBase
    {
        SPARK_CLASS()
    public:
        ...
        void ForEachValue(const std::function<void(const std::pair<std::string, UniformValueBase*>&)>& func);
