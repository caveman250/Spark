...
#include "platform/mac/ObjCUtil.h"
#include <easy/profiler.h>

module Spark.Render.Metal.MetalRenderer;
import Spark.Render.Metal.FrameBuffer;
...
namespace se::render::metal
{
    ...
    void MetalRenderer::Render()
    {
        ...
        auto nativeWindow = se::platform::mac::GetNativeWindow();
