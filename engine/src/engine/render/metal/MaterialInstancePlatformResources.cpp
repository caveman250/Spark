...
module Spark.Render.Metal.MaterialInstancePlatformResources;
...
namespace se::render::metal
{
    ...
    void MaterialInstancePlatformResources::CreatePlatformResources(const std::shared_ptr<Material>& material)
    {
        ...
        auto vertUniforms = se::platform::mac::GetVertUniforms(material.get());
        ...
        auto fragUniforms = se::platform::mac::GetFragUniforms(material.get());
