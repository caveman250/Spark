...
export module Spark.Asset.Shader;
import Spark.Asset.Asset;
export import :ASTNode;
export import :Variable;
export import :InputPortNode;
export import :OutputPortNode;
export import :OutputNode;
export import :Types;
export import :InputNode;
export import :ShaderCompiler;
export import :Operators;
export import :ShaderCompileContext;
export import :NameGenerator;
export import :ShaderSettings;
...
namespace se::asset
{
    ...
    export struct SerializedVariable : reflect::ObjectBase
    {
        SPARK_CLASS()
