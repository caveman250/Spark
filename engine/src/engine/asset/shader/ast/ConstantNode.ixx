...
export module Spark.Asset.Shader:ConstantNode;
import :ASTNode;
import Spark.Math;
...
{
    export typedef std::variant<int, float, math::Vec2, math::Vec3, math::Vec4> ShaderValue;
    export class ConstantNodeBase : public ASTNode
    {
    public:
