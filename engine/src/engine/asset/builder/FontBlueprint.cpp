...
namespace se::asset::builder
{
    ...
    std::vector<std::pair<ui::FloatRect, int>> CollectSortedSDFBoundingBoxes(stbtt_fontinfo& font,
                                                                                        float scale)
    {
    ...
    void CollectCharMetrics(stbtt_fontinfo& font,
                                           char c,
                                           float scale,
                                           float ascent,
                                           CharData& charData)
    ...
    void PackChar(ui::FloatRect FloatRect,
    ...
    memory::BinaryBlob GenerateBitmap(stbtt_fontinfo& font,
        int width,
        int height,
        float scale,
    ...
    memory::BinaryBlob GenerateSDFBitmap(stbtt_fontinfo& font,
                                                        int width,
                                                        int height,
                                                        float scale,
                                                        const std::vector<std::pair<ui::FloatRect, int>>& boundingBoxes,
    ...
    void CreateSDFTexture(stbtt_fontinfo& info,
        Font& font,
        float scale,
        ...
        const std::string& outputPath)
    {
        ...
        for (size_t i = 0; i < numChars; ++i)
        {
            ...
            CollectCharMetrics(info, c, scale, font.GetAscent(FontBlueprint::Scale), charData);
    ...
    std::vector<std::pair<ui::FloatRect, int>> CollectSortedBitmapBoundingBoxes(stbtt_fontinfo& font,
                                                                                     float scale)
    {
        size_t numChars = strlen(s_FontMapChars);
    ...
    void CreateBitmapTexture(stbtt_fontinfo& info,
        Font& font,
        int fontSize,
        std::vector<BuiltAsset>& ret,
        const std::string& outputPath)
    ...
    bool LoadFont(stbtt_fontinfo& font,
                                 void** fontData,
