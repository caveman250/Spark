...
namespace se::ecs
{
    ...
    export class BaseSignal : public reflect::ObjectBase
    {
    private:
    ...
    void ExecuteSignal(const SignalHandle& signal, const std::vector<std::any>& argVec);
