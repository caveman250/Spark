...
add_subdirectory_with_folder("Third Party" third_party/easy_profiler-cc0e154)
...
if (MSVC)
    ...
    target_compile_options(easy_profiler PRIVATE /W0)
    target_compile_options(profiler_gui PRIVATE /permissive-)
else()
    target_compile_options(bc7enc PRIVATE -w)
    target_compile_options(OpenFBX PRIVATE -w)
    target_compile_options(easy_profiler PRIVATE -w)
endif()
...
if (NOT CMAKE_GENERATOR MATCHES "Xcode")
    ...
    add_dependencies(profiler_gui ${REGEN_CMAKE_TARGET})
endif()
