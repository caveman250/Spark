...
namespace crnd
{
    ...
    struct scalar_type
    {
        ...
        static inline void destruct_array(T* p, uint32 n)
        {
...
#pragma warning(disable : 4127)  //  warning C4127: conditional expression is constant
    ...
    public:
        ...
        inline bool get_alloc_failed() const
        {
            return m_alloc_failed;
        }

        inline void clear_alloc_failed()
        {
            m_alloc_failed = false;
        }
...
#pragma warning(pop)
    ...
    struct scalar_type<color_quad<c, q>>
    {
        ...
        static inline void construct_array(color_quad<c, q>* p, uint32 n)
        {
            p, n;
        }
        ...
        static inline void destruct_array(color_quad<c, q>* p, uint32 n)
        {
            p, n;
        }
    };
...
namespace crnd
{
    enum dxt_format
    {
        ...
        cDXN_XY,
        // inverted relative to standard ATI2, 360's DXN
...
namespace crnd
{
    ...
    public:
        ...
        {
            return m_pDecode_tables != NULL;
        }

        inline uint32 get_total_syms() const
        {
            return m_total_syms;
        }

        inline uint32 get_code_size(uint32 sym) const
        {
            return m_code_sizes[sym];
        }
...
namespace crnd
{
    ...
    public:
        ...
        inline uint32 get_data_size() const
        {
            return m_data_size;
        }
