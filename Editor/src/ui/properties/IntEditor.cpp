...
{
    DEFINE_PROPERTY_EDITOR(int, IntEditor);

    DEFINE_SPARK_CLASS_BEGIN(IntEditor)
    DEFINE_SPARK_CLASS_END(IntEditor)

    void IntEditor::SetValue(void* value)
    {
        m_Value = static_cast<int*>(value);
    }

    void IntEditor::ConstructUI(const String& name, bool constructTitle)
    {
